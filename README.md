...
* **Picu katalogs:** Iespēja apskatīt pieejamās picas, cenas un attēlus.
* **Pasūtījuma konstruktors:** Izmēra, mērces un papildu piedevu izvēle.
* **Automātisks aprēķins:** Dinamiska cenas noteikšana atkarībā no picas lieluma un piegādes.
* **Datu saglabāšana:** Čeku ģenerēšana un saglabāšana failā `pasutijumi.txt`, kā arī vēstures nolasīšana.
